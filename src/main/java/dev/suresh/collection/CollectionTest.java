...
public class CollectionTest {
    ...
    void main() {
        ...
        var list = IntStream.range(1, 100_000).parallel().map(i -> i * 2).collect((Supplier<ArrayList<Integer>>) ArrayList::new, ArrayList::add, ArrayList::addAll);
    ...
    public static void teeing() {
        ...
        var employees = Stream.of(new Employee("Employee-1", 30), new Employee("Employee-2", 40), new Employee("Employee-3", 34), new Employee("Employee-4", 45), new Employee("Employee-5", 50));
