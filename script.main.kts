...
@file:DependsOn("io.ktor:ktor-client-core:2.1.1")
@file:DependsOn("io.ktor:ktor-client-cio:2.1.1")
@file:DependsOn("io.ktor:ktor-client-java:2.1.1")
@file:DependsOn("io.ktor:ktor-client-auth:2.1.1")
...
@file:DependsOn("com.microsoft.playwright:playwright:1.25.0")
