#!/usr/bin/env -S kotlin -Xplugin=/usr/local/Cellar/kotlin/1.5.21/libexec/lib/kotlinx-serialization-compiler-plugin.jar

// @file:Repository("https://maven.google.com")
@file:DependsOn("io.ktor:ktor-client-core:1.6.1")
@file:DependsOn("io.ktor:ktor-client-cio:1.6.1")
@file:DependsOn("io.ktor:ktor-client-java:1.6.1")
@file:DependsOn("io.ktor:ktor-client-auth:1.6.1")
...
@file:DependsOn("org.slf4j:slf4j-simple:2.0.0-alpha2")
@file:DependsOn("com.microsoft.playwright:playwright:1.12.1")
