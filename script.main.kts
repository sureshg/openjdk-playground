...
@file:DependsOn("io.ktor:ktor-client-core:2.2.1")
@file:DependsOn("io.ktor:ktor-client-cio:2.2.1")
@file:DependsOn("io.ktor:ktor-client-java:2.2.1")
@file:DependsOn("io.ktor:ktor-client-auth:2.2.1")
